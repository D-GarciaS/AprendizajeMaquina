...
class TreeWindow:
  def __init__(self, master, arbol):
    ...
    figure = Figure(figsize=(15, 8))
    a = figure.add_subplot(111)

    nx.draw(huffTree, pos=pos, with_labels=True, ax=a, node_color='g',  node_shape='s', alpha=0.5, arrows=True)
    ...
    self.plotFrame.pack()
    self.frame.pack()
    self.quitButton = tk.Button(self.frame, text = 'Salir',  command = self.Cerrar_Ventana)
